...
public class MainMenuManager : MonoBehaviour {
	...
	public GameObject UIPanelAbout;

	public GameObject btnRate;
	public GameObject UIPanelRate;
...
//	private string _mainTitle;
	...
	public static void MusicMenuManager(bool active){
		//Se tá ativo seto o mute para false e vice versa
		//MainMenu.GetComponent<AudioSource> ().mute = !active;
	}
	...
	/*
	//Esse método não está sendo usado ainda, depois chamar novas cenas usando ele
	...
	*/
		case "LevelSelect":
			//É aqui que devo chamar a outra tela
//			_LevelsMenu.SetActive(true);
...
//			Application.LoadLevel ("levelSelect");
	...
	public void showRateUI(){
		...
		UIPanelRate.SetActive (true);
		UIPanelRate.GetComponent<Animator> ().SetTrigger ("Show");
	}

	public void hideRateUI(){
		PlaySound(buttonSong);
		btnRate.SetActive (true);
		UIPanelRate.SetActive (true);
		UIPanelRate.GetComponent<Animator> ().SetTrigger ("Hide");
	}

	public void showAboutUI(){
		PlaySound(buttonSong);
		btnAbout.SetActive (false);
		UIPanelAbout.SetActive (true);
		UIPanelAbout.GetComponent<Animator> ().SetTrigger ("Show");
	}
	...
	public void hideAboutUI(){
		...
		UIPanelAbout.SetActive (true);
		UIPanelAbout.GetComponent<Animator> ().SetTrigger ("Hide");
	}
	...
	public void showSettingsUI(){
		...
		UIPanelSettings.GetComponent<Animator> ().SetTrigger ("Show");
	...
	public void hideSettingsUI(){
		...
		UIPanelSettings.SetActive (true);
		UIPanelSettings.GetComponent<Animator> ().SetTrigger ("Hide");
	}
