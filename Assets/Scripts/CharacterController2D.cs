...
public class CharacterController2D : MonoBehaviour {
	...
	[HideInInspector]
	public int playerHealthInicial;
	...
	//TESTE
	void Start(){
		playerHealthInicial = playerHealth;
...
//			Debug.LogWarning("AudioSource component missing from this gameobject. Adding one.");
	...
	public void ApplyDamage (int damage) {
		if (playerCanMove) {
			...
			//atualiza UI
			GameManager.gm.atualizaHealthUI ();
	...
	IEnumerator HurtPlayer(){
		...
		//Tempo aproximado da animação hurt
	...
	public void passaCheckPoint(int posicao){

		if (GameManager.gm) // add the points through the game manager, if it is available
			GameManager.gm.ativaCheckPoint(posicao);
